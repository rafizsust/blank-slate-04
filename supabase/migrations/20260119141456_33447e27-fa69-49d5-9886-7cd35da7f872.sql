-- Create a v2 function to bypass any stale PostgREST schema cache around checkout_key_for_part
-- and to eliminate any possibility of name/column ambiguity.
...
GRANT EXECUTE ON FUNCTION public.checkout_key_for_part_v2(uuid, smallint, integer, text) TO anon, authenticated, service_role;